!(function () {
  ...
  var e,
    ...
    t = function (a, s) {
        ...
        if (0 !== a) {
          if ((y.params.mousewheelInvert && (a = -a), y.params.freeMode)) {
            var i =
              ...
              n = y.isEnd;
            if (
              (i >= y.minTranslate() && (i = y.minTranslate()),
              i <= y.maxTranslate() && (i = y.maxTranslate()),
              y.setWrapperTransition(0),
              y.setWrapperTranslate(i),
              y.updateProgress(),
              y.updateActiveIndex(),
              ((!r && y.isBeginning) || (!n && y.isEnd)) && y.updateClasses(),
      ...
      for (var f in m)
        if (void 0 === s[f]) s[f] = m[f];
        else if ("object" == typeof s[f])
          for (var w in m[f]) void 0 === s[f][w] && (s[f][w] = m[f][w]);
      var y = this;
      if (
        ((y.params = s),
        (y.originalParams = g),
        ...
        (y.container[0].swiper = y),
          ...
          ("fade" !== y.params.effect && "flip" !== y.params.effect) ||
            ...
            (y.params.watchSlidesProgress = !0),
            (y.params.spaceBetween = 0),
            void 0 === c && (y.params.virtualTranslate = !0)),
          ...
          (y.imagesToLoad = []),
          (y.imagesLoaded = 0),
          (y.loadImage = function (e, a, t, s, i, r) {
            function n() {
              r && r();
            }
            var o;
          ...
          (y.preloadImages = function () {
            ...
            for (var a = 0; a < y.imagesToLoad.length; a++)
              y.loadImage(
                ...
                y.imagesToLoad[a].sizes ||
                  y.imagesToLoad[a].getAttribute("sizes"),
                !0,
                e
              );
          }),
          ...
          (y.startAutoplay = function () {
            return (
              ...
              !!y.params.autoplay &&
              !y.autoplaying &&
              ((y.autoplaying = !0), y.emit("onAutoplayStart", y), void r())
            );
          }),
          ...
          (y.pauseAutoplay = function (e) {
            y.autoplayPaused ||
              ...
              (y.autoplayPaused = !0),
              0 === e
                ? ((y.autoplayPaused = !1), r())
                : y.wrapper.transitionEnd(function () {
                    y &&
                      ((y.autoplayPaused = !1),
                      y.autoplaying ? r() : y.stopAutoplay());
                  }));
          }),
          ...
          (y.updateSlidesSize = function () {
            ...
            if (void 0 !== y.size) {
              ...
              if (
                ...
                for (l = [], e = 0; e < y.snapGrid.length; e++)
          ...
          (y.currentSlidesPerView = function () {
            ...
            if (y.params.centeredSlides) {
              var s,
                i = y.slides[y.activeIndex].swiperSlideSize;
              for (e = y.activeIndex + 1; e < y.slides.length; e++)
                y.slides[e] &&
                  !s &&
                  (t++,
                  (i += y.slides[e].swiperSlideSize) > y.size && (s = !0));
              for (a = y.activeIndex - 1; a >= 0; a--)
                y.slides[a] &&
                  !s &&
                  (t++,
                  (i += y.slides[a].swiperSlideSize) > y.size && (s = !0));
            } else
              for (e = y.activeIndex + 1; e < y.slides.length; e++)
          ...
          (y.updateClasses = function () {
            ...
            if (
              (y.params.loop &&
                0 === i.length &&
                (i = y.slides.eq(-1)).addClass(y.params.slidePrevClass),
              s.loop &&
              ...
              "custom" === y.params.paginationType &&
                ...
                (y.paginationContainer.html(
                  y.params.paginationCustomRender(y, r + 1, n)
                ),
          ...
          (y.initEvents = function (e) {
            var a = e ? "off" : "on",
              ...
              n = !!y.params.nested;
            if (y.browser.ie)
              i[t](y.touchEvents.start, y.onTouchStart, !1),
        ...
        (y.onTouchStart = function (a) {
          if (
            ...
            (D = "touchstart" === a.type) || !("which" in a) || 3 !== a.which)
          ) {
        ...
        (y.onTouchMove = function (a) {
          if (
            ...
            if (D && y.params.touchReleaseOnEdges && !y.params.loop)
              if (y.isHorizontal()) {
                if (
            ...
            if (
              ...
              return (b = !0), void (y.allowClick = !1);
            if (
              ...
              if (
                ...
                (y.isHorizontal() && y.touches.currentY === y.touches.startY) ||
              ...
              if (
                (z && y.emit("onTouchMoveOpposite", y, a),
                void 0 === L &&
                  ((y.touches.currentX === y.touches.startX &&
                    y.touches.currentY === y.touches.startY) ||
                    (L = !0)),
                ...
                if (L) {
                  (y.allowClick = !1),
                    ...
                    b ||
                      ...
                      !y.params.grabCursor ||
                        ...
                        y.setGrabCursor(!0)),
                    (b = !0);
                  var i = (y.touches.diff = y.isHorizontal()
                    ? y.touches.currentX - y.touches.startX
                    : y.touches.currentY - y.touches.startY);
                  ...
                  if (
                    ...
                    if (!(Math.abs(i) > y.params.threshold || I))
                      return void (M = P);
                    if (!I)
                      return (
                        (I = !0),
                  ...
                  y.params.followFinger &&
                    ...
                    y.params.freeMode &&
                      ...
                      G.push({
                        position:
                          y.touches[y.isHorizontal() ? "currentX" : "currentY"],
          ...
          if (
            ...
            if (
              (y.allowClick &&
                ...
                i < 300 &&
                  s - H < 300 &&
                  (E && clearTimeout(E), y.emit("onDoubleTap", y, a))),
              (H = Date.now()),
              setTimeout(function () {
                y && (y.allowClick = !0);
              }, 0),
              !T || !b || !y.swipeDirection || 0 === y.touches.diff || M === P)
            )
              return void (T = b = !1);
            if (
              ((T = b = !1),
              (t = y.params.followFinger
                ? y.rtl
                  ? y.translate
                  : -y.translate
                : -M),
              ...
              if (y.params.freeModeMomentum) {
                ...
                if (u < y.maxTranslate())
                  y.params.freeModeMomentumBounce
                    ? (u + y.maxTranslate() < -g && (u = y.maxTranslate() - g),
                      (m = y.maxTranslate()),
                      (c = !0),
                      (k = !0))
                    : (u = y.maxTranslate());
                  ...
                  y.params.freeModeMomentumBounce
                    ? (u - y.minTranslate() > g && (u = y.minTranslate() + g),
                      (m = y.minTranslate()),
                      (c = !0),
                      (k = !0))
                    : (u = y.minTranslate());
                  ...
                  (u =
                    Math.abs(y.snapGrid[h] - u) <
                      Math.abs(y.snapGrid[h - 1] - u) ||
                    "next" === y.swipeDirection
                      ? y.snapGrid[h]
                      : y.snapGrid[h - 1]),
                    y.rtl || (u = -u);
            ...
            for (f = 0; f < y.slidesGrid.length; f += y.params.slidesPerGroup)
              void 0 !== y.slidesGrid[f + y.params.slidesPerGroup]
                ? t >= y.slidesGrid[f] &&
                  t < y.slidesGrid[f + y.params.slidesPerGroup] &&
                  ((w = f),
                  (x =
            ...
            var z = (t - y.slidesGrid[w]) / x;
            if (i > y.params.longSwipesMs) {
              if (!y.params.longSwipes) return void y.slideTo(y.activeIndex);
              "next" === y.swipeDirection &&
                (z >= y.params.longSwipesRatio
                  ? y.slideTo(w + y.params.slidesPerGroup)
                  : y.slideTo(w)),
                "prev" === y.swipeDirection &&
                  (z > 1 - y.params.longSwipesRatio
                    ? y.slideTo(w + y.params.slidesPerGroup)
                    : y.slideTo(w));
            } else {
        ...
        (y.slideTo = function (e, a, t, s) {
          ...
          if (
            ...
            for (var r = 0; r < y.slidesGrid.length; r++)
              -Math.floor(100 * i) >= Math.floor(100 * y.slidesGrid[r]) &&
                (e = r);
          return !(
            (!y.params.allowSwipeToNext &&
              i < y.translate &&
            ...
            (y.rtl && -i === y.translate) || (!y.rtl && i === y.translate)
              ? (y.params.autoHeight && y.updateAutoHeight(),
                y.updateClasses(),
                "slide" !== y.params.effect && y.setWrapperTranslate(i),
                1)
              : (y.updateClasses(),
          ...
          y.isHorizontal() ? (s = y.rtl ? -e : e) : (r = e),
            ...
            y.params.virtualTranslate ||
              (y.support.transforms3d
                ...
                : y.wrapper.transform("translate(" + s + "px, " + r + "px)")),
          ...
          for (
            a.each(function (t, r) {
              ...
              t < y.loopedSlides && i.push(r),
                t < a.length && t >= a.length - y.loopedSlides && s.push(r),
            ...
            y.wrapper.append(
              e(i[t].cloneNode(!0)).addClass(y.params.slideDuplicateClass)
            );
        ...
        (y.appendSlide = function (e) {
          if (
            (y.params.loop && y.destroyLoop(), "object" == typeof e && e.length)
          )
          ...
          cube: {
            setTranslate: function () {
              ...
              y.params.cube.shadow &&
                (y.isHorizontal()
                  ? (0 === (a = y.wrapper.find(".swiper-cube-shadow")).length &&
            ...
            if (y.params.lazyLoadingInPrevNext)
              if (
                ...
                var s = y.params.lazyLoadingInPrevNextAmount,
                  i = t,
                  r = Math.min(
                    y.activeIndex + i + Math.max(s, i),
                    y.slides.length
                  ),
                  n = Math.max(y.activeIndex - Math.max(i, s), 0);
                for (a = y.activeIndex + t; a < r; a++)
                  y.slides[a] && y.lazy.loadImageInSlide(a);
            ...
            function s(a) {
              (e =
                ...
                "slide" === y.params.controlBy &&
                  ...
                  (r = -y.controller.spline.interpolate(-e))),
                (r && "container" !== y.params.controlBy) ||
                  ((i =
                    (a.maxTranslate() - a.minTranslate()) /
                    (y.maxTranslate() - y.minTranslate())),
                  (r = (e - y.minTranslate()) * i + a.minTranslate())),
              ...
              if (e)
                for (var a = 0, t = y.slides.length; a < t; a++) {
                  ...
                  if (
                    ...
                    var i = s.index();
                    y.slideTo(i, 0, y.params.runCallbacksOnInit, !0);
                  }
                }
        ...
        (y.zoom = {
          ...
          onGestureStart: function (a) {
            ...
            (t.gesture.zoomMax =
              t.gesture.imageWrap.attr("data-swiper-zoom") || y.params.zoomMax),
                ...
                ? ((s =
                  ...
                  (i =
                    "touchend" === t.type
                      ...
                      : t.pageY))
                : ((s = y.image.touchesStart.x), (i = y.image.touchesStart.y)),
              y.scale && 1 !== y.scale
    ...
    resize: function () {
      ...
      e.$spacer &&
        setTimeout(function () {
          ...
          e.$spacer.css({ height: a + "px", "background-color": t });
        }, 100);
    },
  }),
    (MIPL.updateResponsiveInit = function () {
      var a = null;
      e(window)
        .on("resize", function () {
          null === a &&
            (a = window.setTimeout(function () {
              (a = null), MIPL.headerSpacer.resize();
            }, 200));
        })
        .resize();
    });
  jQuery(".popup-search"), jQuery(".cart-popup-wrap");
  (MIPL.initSwiper = function () {
    var a = 0,
      s = !1;
    e(".swiper-container").each(function () {
      var i = e(this),
        r = "swiper-unique-id-" + a;
      i.addClass("swiper-" + r + " initialized").attr("id", r),
        i.find(".swiper-pagination").addClass("pagination-" + r);
      var n = i.data("effect") ? i.data("effect") : "slide",
        o = !i.data("crossfade") || i.data("crossfade"),
        l = 0 != i.data("loop") || i.data("loop"),
        p = i.data("show-items") ? i.data("show-items") : 1,
        d = i.data("scroll-items") ? i.data("scroll-items") : 1,
        u = i.data("direction") ? i.data("direction") : "horizontal",
        m = !!i.data("mouse-scroll") && i.data("mouse-scroll"),
        c = i.data("autoplay") ? parseInt(i.data("autoplay"), 10) : 0,
        g = !!i.hasClass("auto-height"),
        h = p > 1 ? 20 : 0;
      p > 1 &&
        (s = {
        ...
        (t["swiper-" + r] = new Swiper(".swiper-" + r, {
          pagination: ".pagination-" + r,
          paginationClickable: !0,
          direction: u,
          mousewheelControl: m,
          mousewheelReleaseOnEdges: m,
          slidesPerView: p,
          slidesPerGroup: d,
          spaceBetween: h,
          keyboardControl: !0,
          ...
          onSlideChangeStart: function (e) {
            if (i.find(".slider-slides").length) {
              i.find(".slider-slides .slide-active").removeClass(
                "slide-active"
              );
              var a = e.slides
                .eq(e.activeIndex)
                .attr("data-swiper-slide-index");
              i.find(".slider-slides .slides-item")
                .eq(a)
      ...
      e(".btn-prev").on("click", function () {
        t["swiper-" + e(this).parent().attr("id")].slidePrev();
      }),
      e(".btn-next").on("click", function () {
        t["swiper-" + e(this).parent().attr("id")].slideNext();
      }),
    ...
    a.ready(function () {
      e("#menu-icon-wrapper").length && MIPL.burgerAnimation(),
        i.length && MIPL.customScroll(),
        r.crumegamenu({
          showSpeed: 0,
          hideSpeed: 0,
          trigger: "hover",
        ...
        MIPL.initSwiper(),
        MIPL.updateResponsiveInit(),
        MIPL.animateSvg();
    });
})(jQuery),
  jQuery,
  (jQuery.fn.crumegamenu = function (e) {});
